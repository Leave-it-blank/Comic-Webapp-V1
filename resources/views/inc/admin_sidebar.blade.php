<nav class="text-left w-full ">
    ...
    <div class=" px-4 m-2  cursor-pointer flex lg:hidden items-center justify-between">
        ...
        <a class="btn" id="yellowbanana">
            <svg class="w-6 h-6 flex items-center flex-inline " fill="none" stroke-linecap="round"
    ...
    <div id="banana" class="sidenav text-sm lg:hidden"
        style="background-color: {{ $settings->admin_siderbar_name }}; color: {{ $settings->admin_side_text_meta }};">
