  ...
  <div class="max-w-md w-full">
    <div>
      ...
      <p class="mt-2 text-center text-sm leading-5 text-gray-600">
        ...
        <a href="#" class="font-medium text-yellow-500 hover:text-yellow-500 focus:outline-none focus:underline transition ease-in-out duration-150">
    ...
    @csrf
      ...
      <div class="mt-6">
        <button type="submit" class="group relative w-full flex justify-center  hover:text-red-500 py-2 px-4 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-yellow-500 focus:outline-none focus:border-yellow-700 focus:shadow-outline-yellow 5ctive:bg-yellow-500 transition duration-150 ease-in-out">
          <span class="absolute left-0 inset-y-0 flex items-center pl-3">
            <svg class="h-5 w-5 text-red-500 group-hover:text-yellow-500  hover:text-green-500 transition ease-in-out duration-150" fill="currentColor" viewBox="0 0 20 20">
