...
<div class="flex flex-col">
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr>@foreach ($users as $user)
              ...
              <td> <a  class="text-gray-500 hover:text-yellow-500"
                             onclick="return confirm('Are you sure?')" href="{{route('admin.users.edit', $user->id)}}"><svg class="w-6 h-6"xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
  <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
</svg></a>
</td><td>
                                <button class="text-gray-500 hover:text-yellow-500" onclick="return confirm('you dont have access to view this!')"  href="#" ><svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
  <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM14 11a1 1 0 011 1v1h1a1 1 0 110 2h-1v1a1 1 0 11-2 0v-1h-1a1 1 0 110-2h1v-1a1 1 0 011-1z" />
                            ...
                            <form action="{{ route('admin.users.destroy', $user) }}" method="POST" class="float-left">
                              @csrf
                               {{ method_field('Delete')}}
                            <button type="submit"  class="text-gray-500 hover:text-yellow-500" onclick="return confirm('Are you sure? you may loose access to panel.')">   <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
