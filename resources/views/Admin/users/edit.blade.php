                        ...
                        <div class=" p-4">
                            ...
                            <form action="{{ route('admin.users.update', $user) }} " method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="email" type="email" class=" p-2 m-3 @error('email') is-invalid @enderror"
                                            style="background-color: transparent;" name="email" value="{{ $user->email }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text" class="p-2 m-3 @error('name') is-invalid @enderror"
                                            style="background-color: transparent;" name="name" value="{{ $user->name }}"
                                            autofocus>
                                ...
                                <button type="submit"
                                    class="hover:border-yellow-500 hover:bg-yellow-300 p-2 m-4 bg-red-600 text-green-200 hover:text-red-700">
                                    UPDATE </button>
                        </div>
                    </div>
