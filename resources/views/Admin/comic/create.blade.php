...
@section('content')
    <div class="container shadow-4xl overflow-auto sm:overflow-hidden">
        ...
        <div class="flex container shadow justify-center">
            <form class="w-full max-w-lg m-4" method="post" action="{{ route('admin.comics.store') }}"
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-2/3 px-3">
                        ...
                        <textarea input
                            class="appearance-none block h-full w-full bg-transparent  border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-transparent focus:border-gray-500"
                            id="grid-desc" type="text" name="desc"> Description </textarea>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-2">
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <div class="relative">
                            <select
                                class="block appearance-none w-full bg-transparent border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-transparent focus:border-gray-500"
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input class="block appearance-none w-full bg-transparent border  "  id="image" type="file"
                            name="image" >
                        <div class="m-4 container">
                            <p class="text-gray-500 text-xs italic">
                                {{ 'Make sure to 450 x 600 (wxh) Cover for best results' }}</p>
                            <p class="text-gray-500 text-xs italic">{{ 'Png, jpg, jpeg' }}</p>
                            <p class="text-gray-500 text-xs italic">
                                {{ 'Title is fixed once url is made  So make sure to name properly.Also 40 characters only :P' }}
                            </p>
                        </div>
                        @error('image')
                            <p class="text-red-500 text-xs italic">{{ $errors }}</p>
