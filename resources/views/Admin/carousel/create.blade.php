...
@section('content')
<div class="">
<a class=" font-bold  md:text-xl hover:text-yellow-500 py-4 w-32">Carousel Creation</a> </div>
...
@if ($errors->any())
    ...
    <form class="w-full max-w-lg m-4" method="post" action="{{ route('admin.carousel.store') }}"  enctype="multipart/form-data">
    @csrf
  ...
  <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
    ...
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
      ...
      <div class="relative">
        <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-position" type="text"  name="position">
